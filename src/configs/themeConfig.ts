 ...
 * as these are stored in the cookie (cookie has the highest priority over the values from default themeConfig):
 * 1. mode: whether the theme is dark, light, or system
 * 2. layout: whether the layout is vertical (sidebar shown) or collapsed (sidebar hidden)
 *
 * To see the effect of the above items, you can clear the cookie from the browser's Application/Storage tab and then
 * reload the page.
 */
...
const themeConfig: Config = {
  templateName: 'Bisajual',
  homePageUrl: '/',
  settingsCookieName: 'userPref',
