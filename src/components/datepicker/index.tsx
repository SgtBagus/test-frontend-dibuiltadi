...
// Styled Components
export const StyledReactDatePicker = styled(Box)<BoxProps>(({ theme }) => {
  return {
    ...
    '& .react-datepicker': {
      ...
      '& .react-datepicker__day': {
        ...
        '&.react-datepicker__day--range-end.react-datepicker__day--in-range': {
          borderRadius: '0 var(--mui-shape-borderRadius) var(--mui-shape-borderRadius) 0',
          color: 'var(--mui-palette-common-white) !important',
          backgroundColor: 'var(--mui-palette-primary-main) !important'
        },
...
const Datepicker = (props: Props) => {
  ...
  return (
    <StyledReactDatePicker {...boxProps} className='w-full'>
      <ReactDatePickerComponent popperPlacement={isMobile ? 'bottom' : 'bottom-start'} {...rest} />
