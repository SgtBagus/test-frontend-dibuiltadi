...
const Navigation = (props: Props) => {
  // Props
  const { mode, systemMode, withTeamSwitcher = true } = props

  // Hooks
  const verticalNavOptions = useVerticalNav()
  const { updateSettings, settings } = useThemeSettings()
  ...
  return (
    ...
    >
      ...
      <VerticalMenu scrollMenu={scrollMenu} withTeamSwitcher={withTeamSwitcher} />
    </VerticalNav>
  )
}
